...
mocness_transect_station <- unite(mocness_full, col = "transect_station", transect, station, sep="_", remove = TRUE)

mocness_depth_range <- unite(mocness_transect_station, col = "depth_range", minimum_depth_m, maximum_depth_m, sep="-", remove = TRUE)
```

```{r Reduce number of larval fish taxa}
taxa_w_gt_15 <- mocness_depth_range %>%
