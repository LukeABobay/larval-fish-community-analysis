...
main_clust_dbRDA_vector_scores <- scores(main_clust_full_model, display = "bp", choices = 1:2) %>%
  ...
  mutate(plot_label = recode(variable,
    ...
    label_x = case_when(
      variable == "mean_temperature_c" ~ -0.85,
      variable == "mean_salinity_psu" ~ -0.92,
      ...
      variable == "depth_mean_m" ~ -1.00,
      variable == "seafloor_depth_m" ~ 0.78,
      variable == "start_latitude_dd" ~ 0.62,
      TRUE ~ base_label_x),
    label_y = case_when(
      variable == "mean_temperature_c" ~ 0.95,
      variable == "mean_salinity_psu" ~ 0.15,
      ...
      variable == "seafloor_depth_m" ~ 0.12,
      variable == "start_latitude_dd" ~ -0.72,
      TRUE ~ base_label_y),
    label_hjust = case_when(
      variable %in% c("mean_temperature_c", "mean_salinity_psu",
                      "depth_mean_m", "year2019", "solar_dayness",
                      "year2018") ~ 1,
